...
config :pou_con, :data_point_manager, PouCon.Hardware.DataPointManager
...
config :pou_con, PouConWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: PouConWeb.ErrorHTML, json: PouConWeb.ErrorJSON],
    layout: false
  ],
...
config :logger_backends, backends: [RingLogger]
