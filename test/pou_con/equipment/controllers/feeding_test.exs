defmodule PouCon.Equipment.Controllers.FeedingTest do
  use PouCon.DataCase
  import Mox
  ...
  setup do
    ...
    device_names = %{
      ...
      to_back_feedback:  "back_fb_#{id}",
      to_front_feedback: "front_fb_#{id}",
  ...
  describe "start/1" do
    test "starts successfully with valid options", %{devices: devices} do
      opts = [
        ...
        to_back_feedback:  devices.to_back_feedback,
        to_front_feedback: devices.to_front_feedback,
