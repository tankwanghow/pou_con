defmodule PouCon.EggCollectionSchedules do
  @moduledoc """
  The EggCollectionSchedules context for managing egg collection automation schedules.
  """

  import Ecto.Query, warn: false
  alias PouCon.Repo

  alias PouCon.EggCollectionSchedules.Schedule

  @doc """
  Returns the list of egg collection schedules.
  ...
  @doc """
  Returns the list of enabled egg collection schedules.
  ...
  ## Examples
      ...
      iex> list_schedules_by_equipment("egg1")
      [%Schedule{}, ...]
