defmodule PouConWeb.Components.Equipment.LightComponent do
  ...
  # ——————————————————————————————————————————————
  # Light Visualization (equipment-specific)
  # ——————————————————————————————————————————————
  ...
  defp light_visualization(assigns) do
    ~H"""
  ...
  def handle_event("set_mode", %{"mode" => mode}, socket) do
    ...
    Light.set_mode(socket.assigns.device_name, mode_atom)
    {:noreply, socket}
  end
